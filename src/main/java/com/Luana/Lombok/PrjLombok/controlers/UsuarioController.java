package com.Luana.Lombok.PrjLombok.controlers;
...
import com.Luana.Lombok.PrjLombok.services.UsuarioService;

import io.swagger.v3.oas.annotations.Operation;
import io.swagger.v3.oas.annotations.tags.Tag;
import jakarta.validation.Valid;

@Tag(name = "Usuarios", description = "API REST DE GERECIAMENTO DE URUÁRIOS")
@RestController
...
public class UsuarioController {
	...
	@PutMapping("/{id}")
	@Operation(summary = "Altera um uruário")
